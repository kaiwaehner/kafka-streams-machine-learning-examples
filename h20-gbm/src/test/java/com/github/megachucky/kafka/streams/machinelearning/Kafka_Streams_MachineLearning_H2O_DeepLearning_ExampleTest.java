...
public class Kafka_Streams_MachineLearning_H2O_DeepLearning_ExampleTest {
    ...
    private String getOutput() {
        ProducerRecord<String, String>  output = testDriver.readOutput(Kafka_Streams_MachineLearning_H2O_DeepLearning_Example.OUTPUT_TOPIC, stringDeserializer, stringDeserializer);
    ...
    @Test
    public void testOne() {
        testDriver.pipeInput(recordFactory.create(Kafka_Streams_MachineLearning_H2O_DeepLearning_Example.INPUT_TOPIC, null, "1987,10,14,3,741,730,912,849,PS,1451,NA,91,79,NA,23,11,SAN,SFO,447,NA,NA,0,NA,0,NA,NA,NA,NA,NA,YES,YES", 1L));
    ...
    public void testList() {
        ...
        testDriver.pipeInput(recordFactory.create(Kafka_Streams_MachineLearning_H2O_DeepLearning_Example.INPUT_TOPIC, records, 1L, 100L));
        assertThat(getOutput()).isEqualTo("Prediction: Is Airline delayed? => YES");
