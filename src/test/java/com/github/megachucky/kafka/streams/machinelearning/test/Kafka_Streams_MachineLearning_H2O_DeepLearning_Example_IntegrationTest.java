 ...
 * embedded Kafka cluster and a H2O.ai DeepLearning Model. 
 * Mostly identical to the GBM example, but uses another Model which was built using H2O's DeepLearning implementation.
 *
 */
public class Kafka_Streams_MachineLearning_H2O_DeepLearning_Example_IntegrationTest {
	...
	public void shouldPredictFlightDelay() throws Exception {
		...
		streamsConfiguration.put(StreamsConfig.APPLICATION_ID_CONFIG, "kafka-streams-h2o-deeplearning-integration-test");
